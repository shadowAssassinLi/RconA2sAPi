...
import cn.qaq.valveapi.chatgpt.sse.ConsoleEventSourceListener;
...
public class OpenAiStreamClient {
    ...
    public void streamCompletions(Completion completion, EventSourceListener eventSourceListener) {
        if (Objects.isNull(eventSourceListener)) {
            log.error("参数异常：EventSourceListener不能为空，可以参考：cn.qaq.valveapi.chatgpt.sse.ConsoleEventSourceListener");
